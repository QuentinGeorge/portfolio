...
?>
    ...
    <section class="page__content index">
                ...
                <?php if($oPost->have_posts()): while($oPost->have_posts()): $oPost->the_post(); ?>
                    <!-- <article class="index__article index__project">
                        <?php if(has_post_thumbnail()): ?>
                            ...
                            <a class="project__link" href="<?php the_permalink(); ?>" title="En savoir plus sur le projet" ><?php the_post_thumbnail('large'); ?></a>
                        <?php else: ?>
                            <h4 class="index__sub-title project__title"><a class="project__link" href="<?php the_permalink(); ?>" title="En savoir plus sur le projet" ><?php the_title(); ?></a></h4>
                        <?php endif; ?>
                    </article> -->
                    <article class="index__article index__project">
        ...
        <section class="page__section index__content why-me">
            ...
            <div class="index__container">
                <article class="index__article why-skill">
                    <h4 lang="en" class="index__sub-title why-skill__title" role="heading" aria-level="3">Responsive Web Design</h4>
                ...
                <article class="index__article why-skill">
                    <h4 class="index__sub-title why-skill__title" role="heading" aria-level="3">Accessibilité et référencement</h4>
